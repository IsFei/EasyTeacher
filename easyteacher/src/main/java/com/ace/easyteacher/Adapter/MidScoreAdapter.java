...
public class MidScoreAdapter extends RecyclerView.Adapter<MidScoreAdapter.ViewHolder> {
    private List<StudentGrade> mList = new ArrayList<>();
    private Context mContext;

    public MidScoreAdapter(Context context, List<StudentGrade> list) {
        this.mList = list;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        StudentGrade studentGrade = mList.get(position);
        holder.bindView(studentGrade);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bindView(StudentGrade studentGrade) {
            ...
            mTv_sid.setText(studentGrade.getSid()+"");
