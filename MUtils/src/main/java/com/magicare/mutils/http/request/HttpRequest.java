...
import com.magicare.mutils.http.body.ProgressBody;
...
public class HttpRequest extends UriRequest {
    ...
    public void sendRequest() throws IOException {
        ...
        if (responseCode >= 300) {
            ...
            MLog.e(httpException.toString() + ", url: " + queryUrl+" "+responseCode);
            throw httpException;
        }
    ...
    public Object loadResultFromCache() throws Throwable {
        isLoading = true;
        HttpCacheEntity cacheEntity = HttpCache.getCache(getCacheKey());

        if (cacheEntity != null) {
            MLog.d("JUSTIN", "cache 剩余 time：" + (cacheEntity.getLife() - System.currentTimeMillis()));
